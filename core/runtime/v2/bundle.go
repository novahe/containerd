...
// TraverseBundles traverses the bundles in the stateDir.
// If traverse returns an error, the bundle will be cleaned up.
func TraverseBundles(ctx context.Context, stateDir string, traverse traverseFn) error {
...
func TraverseWorkDirs(ctx context.Context, rootDir string, traverse traverseWorkDirFn) error {
